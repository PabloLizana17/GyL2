...
//$complemento1 = complemento($automata1['Cnodos'],$lineas1['conexiones'],$lineas1['caminos'],$automata1['inicio'],$automata1['Fin']);
//$complemento2 = complemento($automata2['Cnodos'],$lineas2['conexiones'],$lineas2['caminos'],$automata2['inicio'],$automata2['Fin']);
