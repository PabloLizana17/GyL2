<?php
    ...
    $letra=$_GET['letra'];
	$lleg=$_GET['lleg'];
    $guardar=fopen('cam1.txt','a+');
    fwrite($guardar,$ini);
    fwrite($guardar,",");
	fwrite($guardar,$lleg);
	fwrite($guardar,"\n");
	fwrite($guardar,$letra);
	fwrite($guardar,"\n");
    fclose($guardar);
?>
<!DOCTYPE HTML>
		...
		<div class="container">
			...
			<div class="row animate-box">	
				<div class="col-md-6 col-md-offset-3 text-center heading-section">
					<h3>Demostracion</h3>
					<p align = "justify">Ingrese valores AUTOMATA 1:</p>
					<form action="recoleccion_de_datos1" mclass="#fh5co-started" method="GET">
						<p align = "text-center">	
				...
				<div>
                <a href="automata2"><input type="button" value="Rellenar AUTOMATA 2"></a>
			</div>
		</div>
	</div>
