			...
			<div class="row animate-box">	
				<div class="col-md-6 col-md-offset-3 text-center heading-section">
                    ...
                    <p align = "justify">
                        1. 
                        <br>
                        2. Automata 1: <?php echo  $camino1;?>, Automata 2: <?php echo $camino2;?> <br>
                        Complemento 1: <?php //echo $complemento1;?>, Complemento 2: <?php //echo $complemento2;?><br>
                        Union: <?php echo $union;?>, interseccion: <?php echo $interseccion;?>, concatenacion: <?php echo $concatenacion;?><br>
                        3.
